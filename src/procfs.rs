...
fn dec_number(i: &str) -> IResult<&str, u64> {
    ...
    let num = s.parse().expect("our decimal parser is wrong");
    Ok((i, num))
}
...
/// parsed a Linux device number in from major:minor, where
